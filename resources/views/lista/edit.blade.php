        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area">
                <div class="row align-items-center mb-3">
                    <div class="col-md-6">
                        <h3 class="mb-0">Editar Lista</h3>
                    </div>
                </div>
                @include('varios.mensaje')
                <form id="form_general" action="{{route('lista.update', $data)}}" method="post"
                    onsubmit="
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-row mb-2">
                                <div class="form-group col-md-3">
                                    ...
                                    <input name="lista" id="lista" type="text" class="form-control" value="{{old('lista', $data->descripcion)}}" required>
                                </div>

                                <div class="form-group col-md-3">
                                    <label for="opcion">Opcion</label>
                                    <input name="opcion" id="opcion" type="text" class="form-control" value="{{old('opcion', $data->opcion)}}" onkeyup="punto_decimal(this)" required>
                                </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="movimiento_id" id="movimiento_id" class="form-control">
                                        @foreach ($movimientos as $item)
                                            <option {{ ( old('movimiento_id', $data->movimiento_id) == $item->id ? 'selected' : '') }} value="{{$item->id}}">{{$item->descripcion}}</option>
                                        @endforeach
                                    </select>
                                </div>
